...
\pagestyle{headings}
    ...
    \include{sections/LavoroCorrelato}
    \include{sections/Strategie}
    \include{sections/UnoStrumentoPerLAssessment}
    \include{sections/RisultatiEdEsperimenti}
    ...
    \chapter*{Ringraziamenti}
        ...
        Un sentito ringraziamento anche alla mia seconda famiglia: Alessandro Barba, Lucrezia, Letizia e al resto della famiglia Zanetti, grazie per avermi supportato e sopportato per tutti questi anni. Ho imparato tanto da voi, ad ascoltare, a mantenere la calma e la razionalità anche nelle discussioni più accese e persino qualche parola in bresciano.
        ...
        Grazie anche al professor Masetti per avermi fatto innamorare di questa disciplina. Probabilmente se non avessi avuto lei come professore, questa tesi sarebbe rimasta nella penna per sempre. 

        Un Grazie speciale a chi mi ha supportato in questo ultimo difficile periodo: 
